...
|------|-----------------|----------------|
| **CI-001: Rep Talk Ratio** | Percentage of time the rep speaks vs. listens. Ideal range: 40-50%. | Reps who talk >60% aren't listening. Reps who talk <30% may lack control of the conversation. |
...
1. **Email domain matching** -- External participant email domains (e.g., `@legendsoflearning.com`) are matched against the `domain` field on your PILLAR accounts
