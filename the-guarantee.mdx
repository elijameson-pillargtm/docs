---
title: 'The Guarantee'
description: "PILLAR's three-link chain of Spec → Guarantee → Test. Every behavior we commit to is a named, enforced, append-only invariant — 66 spec entries, 63 Guarantees across 17 categories, 2,479 tests on every commit."
icon: 'shield-check'
---
...
**Current count: 2,479 tests** — 2,376 unit + 103 integration running on every commit, plus 3 Playwright UI tests against the public auth + unsubscribe surfaces.
