...
- **Pure private-market K-12 SaaS** (Legends of Learning) → EdTech
- **AI-platform / PLG-leaning** (LoL with product usage telemetry, AI-tooling vendors) → AI-Automation (often stacked with EdTech)
- **State/local/federal** (any public-sector seller) → Public-Sector
- **Hybrid district + family-direct** (Springboard Collaborative) → Family-Literacy (often stacked with Public-Sector since they sell to districts)
...
No preset library can anticipate a customer's most differentiated leading indicator. Springboard's "completion-rate drop" rule is one example — it's tuned to their leading indicator, not a generic K-12 indicator. Legends of Learning's "summer dampening" rule is another — it relaxes SLA timers June-August because their teacher engagement legitimately drops over summer.
...
See the [Legends of Learning Implementation Plan](https://pillargtm.com/implementations/legends-of-learning) for a worked example.
