...
## Contracts (starbridge\_contracts)
...
## Purchase Orders (starbridge\_purchase\_orders)
...
## Competitor Contracts (competitor\_contracts)
...
- **competitive_displacement_window** (PIPELINE): When a competitor contract is within the competitor_contract_expiry_days threshold (default: 120 days). CRITICAL if under 60 days to expiry, WARNING if under 180 days.
