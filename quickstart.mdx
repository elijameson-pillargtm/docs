...
Every authenticated PILLAR page has a floating **✦ Drafter** button in the bottom-right. Drafter is the in-app AI agent — ask any GTM question and it picks the right tools from the 128 MCP tool surface, pulls evidence, and returns a specific answer with citations.
...
3. Start asking natural-language questions ("what's at risk this quarter?", "simulate NRR going from 108% to 115%", "generate a board narrative for Tuesday")

See the [MCP Server guide](/api/mcp) for the full 128 MCP tool catalog (62 vertical_intelligence + others) and example conversations.
