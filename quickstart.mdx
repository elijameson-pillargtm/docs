...
Every authenticated PILLAR page has a floating **✦ Drafter** button in the bottom-right. Drafter is the in-app AI agent — ask any GTM question and it picks the right tools from the 70+ MCP tool surface, pulls evidence, and returns a specific answer with citations.
...
See the [MCP Server guide](/api/mcp) for the full 70+ MCP tool catalog and example conversations.
